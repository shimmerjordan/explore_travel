      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton<String>(
            ...
            onSelected: (v) {
              if (v == 'file') TrackImportFlow.fromFile(context, ref);
              if (v == 'photos') TrackImportFlow.fromPhotos(context, ref);
            },
            itemBuilder: (_) => const [
              PopupMenuItem(
                  value: 'file',
                  child: Text('从轨迹文件（GPX / KML / KMZ / GeoJSON）')),
              PopupMenuItem(
                  value: 'photos', child: Text('从照片定位点亮轨迹')),
            ],
          ),
